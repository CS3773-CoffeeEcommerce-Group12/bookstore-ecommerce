...
-- Update the fn_checkout function to store discount information
...
begin
  ...
  insert into public.orders (user_id, customer_email, total_cents, shipping_address_id, discount_code, discount_pct)
  values (
    v_user,
